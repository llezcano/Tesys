...
yy: {},
symbols_: {"error":2,"expressions":3,"e":4,"EOF":5,"+":6,"-":7,"*":8,"/":9,"NUMBER":10,"METRIC":11,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"+",7:"-",8:"*",9:"/",10:"NUMBER",11:"METRIC"},
...
var $0 = $$.length - 1;
switch (yystate) {
case 1:return "\"value\":" + $$[$0-1]  ;
break;
case 2: this.$ = "{\"Suma\": [ "+$$[$0-2]+" , "+$$[$0]+" ]}" ;
break;
case 3:this.$ = "{\"Resta\": [ "+$$[$0-2]+" , "+$$[$0]+" ]}" ;
break;
case 4:this.$ = "{\"Multiplicacion\": [ "+$$[$0-2]+" , "+$$[$0]+" ]}" ;
break;
case 5:this.$ = "{\"Division\": [ "+$$[$0-2]+" , "+$$[$0]+" ]}" ;
break;
case 6:this.$ = "{\"Constant\":\""+yytext+"\"}";
break;
case 7:this.$ = "{\"SimpleValue\":\""+yytext+"\"}";
break;
}
},
table: [{3:1,4:2,10:[1,3],11:[1,4]},{1:[3]},{5:[1,5],6:[1,6],7:[1,7],8:[1,8],9:[1,9]},{5:[2,6],6:[2,6],7:[2,6],8:[2,6],9:[2,6]},{5:[2,7],6:[2,7],7:[2,7],8:[2,7],9:[2,7]},{1:[2,1]},{4:10,10:[1,3],11:[1,4]},{4:11,10:[1,3],11:[1,4]},{4:12,10:[1,3],11:[1,4]},{4:13,10:[1,3],11:[1,4]},{5:[2,2],6:[2,2],7:[2,2],8:[1,8],9:[1,9]},{5:[2,3],6:[2,3],7:[2,3],8:[1,8],9:[1,9]},{5:[2,4],6:[2,4],7:[2,4],8:[2,4],9:[2,4]},{5:[2,5],6:[2,5],7:[2,5],8:[2,5],9:[2,5]}],
