 ...
 * los programas o por el mismo usuario
 * 
 * Una metrica simple seria lineas de codigo, esta metrica probablemente la defina
 * el sonar y es considerada una metrica simple ya que se encuentra directamente en 
 * el mapa de la clase issue
 * 
 * Otra metrica puede ser loc/horas y es considerada una metrica compuesta
 * dado que no se encuentra directamente en issue, sino que debe ser calculada
 * 
