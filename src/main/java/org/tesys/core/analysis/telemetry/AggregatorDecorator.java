...
/**
 * Decorator de aggregator, cada programa que se agrege a tesys debe tener al menos
 * un hijo de esta clase que sera encargado de adjuntar los datos a los de los demas programas
 *
 */
