 ...
 *  
 * Para eso se utiliza el patron decorate, donde ProjectTrackingAggregator es la hoja
 * 
 * y todos los hijos debren heredar de AggregatorDecorator para poder agregar sus
 * metricas a la par de los demas programas
 *
 */
