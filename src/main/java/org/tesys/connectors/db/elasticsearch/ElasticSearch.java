...
public class ElasticSearch {
  ...
  /**
   * Usada solamente para busquedas, se debe utilizar PUT para updates o implementar El otro metodo
   * 
   * 
   * Como search nomas esta limitado a 10 por defecto lo que se hace es verificar en primer lugar
   * cuantos datos tiene el lugar donde se va buscar
   * 
   * Una vez que se sabe la cantidad de datos se hace la busqueda y se pide que se retorne Esa
   * cantidad como maximo (aunque la query puede reducir el tamaño al igual que el filtro)
   * 
   * @param index
   * @param dtype
   * @param query
  ...
  public String POST(@PathParam("index") String index, @PathParam("dtype") String dtype,
    ...
    // TODO si devuelve 0 resultados seguro se debe romper (testear todos los metodos con db vacia y
    // cosas asi)
  ...
  /**
   * Este metodo devuelve la cantidad de elementos del indice ese para poder hacer una consulta de
   * el tamaño indicado
   * 
   * @param index
   * @param dtype
