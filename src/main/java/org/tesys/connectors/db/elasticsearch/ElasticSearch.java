...
public class ElasticSearch {
    ...
    private Integer getSize(String index, String dtype) {
    	...
    	JsonNode jsonResponse = client.GET(pathToStore(index, dtype, QUERY), param).readEntity(JsonNode.class);
	...
	JsonNode jsonResponse = client.POST(this.pathToStore(INDEX_SCM, DTYPE_USER, QUERY) ,  query).readEntity(JsonNode.class) ;
