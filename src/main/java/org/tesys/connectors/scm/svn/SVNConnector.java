...
public class SVNConnector {
   ...
   * 
   * El servidor svn se guarda en esta clase pero el repositorio y la version tienen que pasarse
   * como parametro
   * 
   * Cualquier checkout que se haga se hace en la carpeta home dentro de la carpeta ".tesys"
   * 
