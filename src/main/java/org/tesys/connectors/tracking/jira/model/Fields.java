...
public class Fields {
  ...
  public String toString() {
    return "Fields [progress=" + progress + ", subtasks=" + Arrays.toString(subtasks)
        + ", issuetype=" + issuetype + ", status=" + status + ", workratio=" + workratio
        + ", assignee=" + assignee + ", resolutiondate=" + resolutiondate
        + ", aggregatetimeestimate=" + aggregatetimeestimate + ", reporter=" + reporter
        + ", aggregatetimeoriginalestimate=" + aggregatetimeoriginalestimate + ", project="
        + project + ", updated=" + updated + ", created=" + created + ", priority=" + priority
        + "]";
  }
}
